(function() {
  ...
  Calendar = (function() {
    ...
    Calendar.prototype.dayClass = function(day, month, firstDayOfMonth, lastDayOfMonth) {
      var classes, date;
      date = new Date(this.visibleYear(), month - 1, day);
      classes = '';
    ...
    Calendar.prototype.drawDays = function() {
      var firstDayOfMonth, i, lastDayOfMonth, self, _i, _j, _ref, firstDayOfLastMonth, lastDayOfLastMonth, daysToNextMonth;
      self = this;
      this.$days.empty();
      ...
      firstDayOfLastMonth = this.firstDayOfMonth(this.visibleMonth() + 1, this.visibleYear());
      lastDayOfLastMonth = this.daysInMonth(this.visibleMonth() - 1, this.visibleYear());
      daysToNextMonth = 42 - (lastDayOfMonth + firstDayOfMonth - 1);
      for (i = _i = 1, _ref = firstDayOfMonth - 1; _i <= _ref; i = _i += 1) {
        var startDayOfLastMonth = lastDayOfLastMonth - firstDayOfMonth + 1 + i;
        this.$days.append($("<li class='drp-day drp-lastmonth " + (this.dayClass(startDayOfLastMonth, this.visibleMonth() - 1, firstDayOfMonth, lastDayOfMonth)) + "'>" + startDayOfLastMonth + "</li>"));
      }
      for (i = _j = 1; _j <= lastDayOfMonth; i = _j += 1) {
        this.$days.append($("<li class='drp-day " + (this.dayClass(i, this.visibleMonth(), firstDayOfMonth, lastDayOfMonth)) + "'>" + i + "</li>"));
      }
      for (i = 1; i <= daysToNextMonth; i++) {
        this.$days.append($("<li class='drp-day drp-nextmonth " + (this.dayClass(i, this.visibleMonth() + 1, firstDayOfMonth, lastDayOfMonth)) + "'>" + i + "</li>"));
      }
      return this.$calendar.find('.drp-day').click(function(evt) {
        ...
        if ($(this).hasClass('drp-lastmonth')) {
            self.showPreviousMonth();
        }
        else if ($(this).hasClass('drp-nextmonth')) {
            self.showNextMonth();
        }
